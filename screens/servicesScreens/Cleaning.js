...
export default function Cleaning() {
  return (
    <View style={styles.container}>
      ...
      <Image style={styles.img} source={require('../../assets/images/hk.jpg')}/>
      ...
      <View style={styles.options}>
        ...
        <TouchableOpacity style={styles.option}>
          <View style={styles.optionText}>
            ...
            <Text style={styles.optionBody}>Choose a cleaning agency</Text>
          </View>
          <AntDesign style={styles.icon} name='right'/>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.option}>
          <View style={styles.optionText}>
            ...
            <Text style={styles.optionBody}>Select a specific service content</Text>
          </View>
          <AntDesign style={styles.icon} name='right'/>
        </TouchableOpacity>
